...
def main():
    ...
    test_speed = 1 * 255
    pos = [0, 2, -1.2, 2.3, -0.3, -3.2]
    for p in pos:
        print("Pos: " + str(p) + " T: " + str(len(threading.enumerate())))
        ...
        t1 = threading.Thread(
            ...
            args=(GpioPins_MA, test_speed, p, "d", True, False, "full"),
        )
        ...
        t2 = threading.Thread(
            ...
            args=(GpioPins_MB, test_speed, -p, "d", True, False, "full"),
        )
        t2.start()
        time.sleep(0.01)
